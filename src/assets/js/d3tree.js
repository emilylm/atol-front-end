            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    for (var i = 0; i < total; i++) {
                        ...
                        var baseUrl = window.ergaBaseUrl || 'http://localhost:4200';
                        var organismElement = '<a class="no-underline" target="_blank" href="' + baseUrl + '/data_portal/' + organismId + '">' + organism + '</a>'
